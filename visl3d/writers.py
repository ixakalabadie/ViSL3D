...
class WriteVis:
    ...
    def func_background(self):
        ...
        self.visfile.write(misc.tabs(5)+"var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(hex);\n")
    ...
    def func_markers(self):
        ...
        self.visfile.write(misc.tabs(4)+"if (marktype.value == 'sphere') {\n")
        self.visfile.write(misc.tabs(5)+f"sph_coords = createSphere(sca, selsph, col, sph_coords, means, delt, trans);\n")
        self.visfile.write(misc.tabs(4)+"} else if (marktype.value == 'box') {\n")
        self.visfile.write(misc.tabs(5)+"box_coords = createBox(sca, selbox, col, box_coords, means, delt, trans);\n")
        self.visfile.write(misc.tabs(4)+"} else if (marktype.value == 'tub') {\n")
        self.visfile.write(misc.tabs(5)+"tub_coords = createTub(sca, seltub, col, tub_coords, tubelen, means, delt, trans);\n")
        self.visfile.write(misc.tabs(4)+"} else if (marktype.value == 'con') {\n")
        self.visfile.write(misc.tabs(5)+"con_coords = createCon(sca, selcon, col, con_coords, means, delt, trans);\n")
        self.visfile.write(misc.tabs(3)+"}\n")
        self.visfile.write(misc.tabs(2)+"}\n\n")
