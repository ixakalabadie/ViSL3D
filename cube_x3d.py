...
class write_html:
    ...
    def func_tubes(self):
        ...
        self.write_html(tabs(3) + '<input type="number" id="sphX0" step="1" placeholder="RA">\n')
        self.write_html(tabs(3) + '<input type="number" id="sphY0" step="1" placeholder="Dec">\n')
        self.write_html(tabs(3) + '<input type="number" id="sphZ0" step="1" placeholder="V">\n')
        ...
        self.write_html(tabs(3) + '<input type="number" id="boxX0" step="1" placeholder="RA">\n')
        self.write_html(tabs(3) + '<input type="number" id="boxY0" step="1" placeholder="Dec">\n')
        self.write_html(tabs(3) + '<input type="number" id="boxZ0" step="1" placeholder="V">\n')
